...
export type Action = Actions.ReceiveProductRecords | Actions.ReceiveMoreProducts | Actions.ReceiveCustomFetchProducts;
...
export function updateTrendingProducts(state: State, action: Action) {

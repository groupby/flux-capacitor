...
export const createAction = <T extends string, P>({ type, payload, section }: { type: T, payload?: P, section?: Actions.StoreSection }, validator?: object): Actions.Action<T, P> => {
  const builtAction: Actions.Action<T, P> = { type, meta: { validator: validator || {}, section: section || Actions.StoreSection.Data } };
